...
# IAM Module
# =============================================================================
# Creates IAM roles and policies for ECS tasks and other services.
# =============================================================================
...
# Custom policy for Secrets Manager access (execution role)
...
resource "aws_iam_role_policy" "ecs_execution_ecr" {
  name = "${var.name_prefix}-ecs-execution-ecr"
  role = aws_iam_role.ecs_execution.id
...
# Task role policy for runtime Secrets Manager access
