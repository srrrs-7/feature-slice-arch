...
**Loading Instructions**: Read these rule files to ensure task generation follows TDD methodology (tests before implementation), proper testing patterns, and aligns with project architecture.
