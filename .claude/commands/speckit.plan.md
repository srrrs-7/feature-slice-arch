...
| `/workspace/main/.claude/rules/planing.md` | Planning process and templates | ✅ |
| `/workspace/main/.claude/rules/coding-rules.md` | Coding standards and patterns | ✅ |

**Loading Instructions**: Read these rule files to ensure the implementation plan follows project architecture (Feature-Sliced), uses proper coding patterns, and adheres to the planning process.
